...
import edu.alexey.animalshaven.AppSettings;
import edu.alexey.animalshaven.client.viewmodels.ViewModelBase;
import edu.alexey.utils.UncloseableInputStream;

public class ConsoleView implements View {

	protected static final Scanner SCANNER = new Scanner(UncloseableInputStream.wrap(System.in), AppSettings.CHARSET);
